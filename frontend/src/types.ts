...
export type LlmConfiguration={configured:boolean;base_url?:string;api_key_masked?:string;auth_type?:'api_key'|'auth_token';model?:string;small_fast_model?:string|null;timeout_seconds?:number;max_turns?:number;default_permission_mode?:PermissionMode;last_test_ok?:boolean|null;last_test_message?:string|null;last_tested_at?:string|null;hermes_configured?:boolean;hermes_base_url?:string;hermes_api_key_masked?:string;hermes_model?:string;hermes_timeout_seconds?:number;hermes_last_test_ok?:boolean|null;hermes_last_test_message?:string|null;hermes_last_tested_at?:string|null;updated_at?:string}
